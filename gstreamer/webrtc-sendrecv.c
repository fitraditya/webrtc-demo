...
static const gchar *server_url = "ws://localhost:8000";
...
setup_call (void)
{
  ...
  msg = g_strdup_printf ("CALL %s", peer_id);
...
register_with_server (void)
{
  ...
  hello = g_strdup_printf ("REGISTER %i", our_id);
    ...
    GBytes * message, gpointer user_data)
{
  ...
  } else if (g_strcmp0 (text, "CALL_OK") == 0) {
